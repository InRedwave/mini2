...
<body>
	...
	<div id="bottomViewPort" class="wrapper d-flex">
		...
		<div class="d-flex flex-column col-10">
			...
			<hr class="mb-4" />
			<div id="selectCondition" class="d-flex justify-content-between">
				<div class="conditionSet d-flex justify-content-center align-items-center flex-fill">
					<h6 class="col-5 text-center">종류</h6>
				...
				<div class="conditionSet d-flex justify-content-center align-items-center flex-fill">
					<h6 class="col-6 text-center">상세 종류</h6>
				...
				<div class="conditionSet d-flex justify-content-center align-items-center flex-fill">
					<h6 class="col-8 text-center">리스트 최대치</h6>
				...
				<div class="conditionSet d-flex align-items-center flex-fill">
					<div>
				...
				<div class="titleInfo">
					<div class="d-flex">
						...
						<div class="titleContentInfo col-11">
							<div class="d-flex">
								<h6 class="col-6">제목</h6>
								<h6 class="col-2">글쓴이</h6>
								<h6 class="col-2">날짜</h6>
								<h6 class="col-2">평점</h6>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="titleBlock d-flex">
						...
						<div class="titleContent col-11">
							<div class="titleTop d-flex">
								<h6 class="col-6">앞광고) 갤럭시 S222 Note 리뷰</h6>
								<h6 class="col-2">Samsung</h6>
								<h6 class="col-2">2222-2-22</h6>
								<h6 class="col-2">2.2</h6>
							</div>
			...
			<div class="pager d-flex justify-content-around my-3">
				...
				<div class="pagingButtonSet d-flex justify-content-around col-7">
